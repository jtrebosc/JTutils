...
mnemonique=[]
channelmap=[]
# trouver les channels utilises dans le pp
...
#inf1=float(dtst.readacqpar("INF 1",status=True),)
#swh=1e6/inf1
...
exptype=SELECT(title="Kind of experiment",message="What is the experiment that need universal scaling in F1?",buttons=["3QMAS","5QMAS","STMAS"])
...
if exptype==1:
	...
	nf=-1./2.
	mf=1./2.
# STMAS correlates ST coherence with CT coherence
if exptype==2:
	ni=3./2.
	mi=1./2.
	nf=-1./2.
